...
contract AlphaTestDeploy is TestHelperOz5 {
    ...
    uint256 private initialSupply = 1_000_000_000 ether;
    ...
    function test_constructor() public {
        ...
        assertEq(aOFT.balanceOf(userA), initialSupply);
    ...
    function test_send_oft() public {
        ...
        assertEq(aOFT.balanceOf(userA), initialSupply - tokensToSend);
        assertEq(bOFT.balanceOf(userB), 0 + tokensToSend);
    }
